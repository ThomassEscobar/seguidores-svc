# Seguidores — Despliegue y operación
...
| API base | `/api/seguimientos` |

## Docker

```bash
docker build -t duoc/jv0101-caso12-seguidores:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso12-seguidores:1.0.0
```
