# Seguidores — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Seguidores del caso caso12 (DevConnect).

## Contexto

- **Caso**: caso12 — DevConnect (Red social de comunidad profesional)
- **Microservicio**: seguidores
